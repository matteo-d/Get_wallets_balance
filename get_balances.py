...
TOTAL_STACK = TOTAL_BALANCE_ON_EXCHANGE + BANK * 1.08
SHOULD_BE_ON_EXCHANGE = TOTAL_STACK * 0.65
SHOULD_BE_ON_INTRAS = TOTAL_STACK * 0.0133
SHOULD_BE_ON_CLASSICS = TOTAL_STACK * 0.0399
SHOULD_BE_ON_SWINGS = TOTAL_STACK * 0.1197
DIFFERENCE = SHOULD_BE_ON_EXCHANGE - TOTAL_BALANCE_ON_EXCHANGE 
